...
class DiagnosticsTest(unittest.TestCase):
    def test_collect_diagnostics_marks_ready_when_required_tools_exist(self):
        ...
        self.assertEqual(diagnostics.backend_priority, ["lsof", "ss"])
        self.assertEqual(diagnostics.active_backend, "lsof")
        self.assertEqual(diagnostics.available_port_check_tools, ["lsof", "ss"])
        self.assertEqual(diagnostics.available_required_tools, ["ps"])
    ...
    def test_collect_diagnostics_reports_missing_port_checker(self):
        ...
        self.assertEqual(diagnostics.backend_priority, ["lsof", "ss"])
        self.assertEqual(diagnostics.available_port_check_tools, [])
        self.assertEqual(diagnostics.available_required_tools, ["ps"])
        ...
        self.assertEqual(payload["available_port_check_tools"], [])
        ...
        self.assertIn("backend priority", " ".join(payload["notes"]))
    ...
    def test_collect_diagnostics_uses_ss_when_lsof_is_missing(self):
        ...
        self.assertEqual(diagnostics.available_port_check_tools, ["ss"])
    ...
    def test_missing_required_tool_is_reported_as_failure_reason(self):
        ...
        self.assertEqual(diagnostics.available_required_tools, [])
    ...
    def test_format_diagnostics_report_includes_platform_notes_actions_and_install_hints(self):
        ...
        self.assertIn("Backend priority: lsof -> ss", report)
        ...
        self.assertIn("backend priority", report)
